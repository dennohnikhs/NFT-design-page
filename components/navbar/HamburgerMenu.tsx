      ...
      >
        ...
        >
          <Link href="/">
            ...
            <img src={theme ==='dark' ? "/SmashNFT-logo/19.png" : "/SmashNFT-logo/20.png"}  style={{height:30}} alt="" />
              {/* <Image
        ...
        {isConnected ? (
          ...
          >
            <Link href={`/portfolio/${connectedWallet}`} legacyBehavior>
              <Flex
                css={{
                  justifyContent: 'space-between',
                  alignItems: 'center',
              ...
              >
                <Flex css={{ alignItems: 'center' }}>
                  {ensAvatar ? (
                    ...
                    <Jazzicon
                      diameter={36}
                      seed={jsNumberForAddress(connectedWallet as string)}
                    />
                  )}
        ...
        >
          <a href="https://twitter.com/smashplay2win" target="_blank">
            <Button
              css={{ justifyContent: 'center', width: '44px', height: '44px' }}
              type="button"
              size="small"
          ...
          <a href="https://discord.gg/fmrkosmo" target="_blank">
            <Button
              css={{ justifyContent: 'center', width: '44px', height: '44px' }}
              type="button"
              size="small"

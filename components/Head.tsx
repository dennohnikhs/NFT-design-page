...
export const Head: FC<Props> = ({
  ogImage = 'https://i.postimg.cc/JnkDsqmg/Screenshot-1.png',
  title = 'SMASHNFT | Multi-Chain NFT Explorer',
  description = 'SmashNFT Multi-Chain NFT Explorer is built with Reservoir.',
}) => {
  return (
    <NextHead>
      ...
      <meta property="og:image:alt" content="SmashNFT Explorer Banner" />
    </NextHead>
  )
}

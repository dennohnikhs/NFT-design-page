...
const companySectionLinks = [
  {
    ...
    href: '/polygon/collections/trending',
  },
  {
    name: 'Terms of Use',
  ...
  return (
    ...
    >
      <Flex css={{ gap: 80, '@bp600': { gap: 136 } }}>
        ...
        <Flex direction="column">
          <img src={theme ==='dark' ? "/SmashNFT-logo/19.png" : "/SmashNFT-logo/20.png"}  style={{height:36,marginBottom:5}} alt="" />
      ...
      >
        <SectionTitle title="Join SmashNFT Community" />
        <Flex css={{ gap: '$4', mt: 16 }}>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://twitter.com/smashplay2win"
          >
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://discord.gg/fmrkosmo"
          >
            <Button size="xs" color="gray3">

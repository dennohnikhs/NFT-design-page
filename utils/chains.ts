...
import {  NEXT_PUBLIC_ARBITRUM_COLLECTION_SET_ID, NEXT_PUBLIC_ARBITRUM_COMMUNITY, NEXT_PUBLIC_ARBITRUM_NOVA_COLLECTION_SET_ID, NEXT_PUBLIC_ARBITRUM_NOVA_COMMUNITY, NEXT_PUBLIC_AVALANCHE_COLLECTION_SET_ID, NEXT_PUBLIC_AVALANCHE_COMMUNITY, NEXT_PUBLIC_BASE_COLLECTION_SET_ID, NEXT_PUBLIC_BASE_COMMUNITY, NEXT_PUBLIC_BSC_COLLECTION_SET_ID, NEXT_PUBLIC_BSC_COMMUNITY, NEXT_PUBLIC_ETH_COLLECTION_SET_ID, NEXT_PUBLIC_ETH_COMMUNITY, NEXT_PUBLIC_GOERLI_COMMUNITY, NEXT_PUBLIC_LINEA_COLLECTION_SET_ID, NEXT_PUBLIC_LINEA_COMMUNITY, NEXT_PUBLIC_OPTIMISM_COLLECTION_SET_ID, NEXT_PUBLIC_OPTIMISM_COMMUNITY, NEXT_PUBLIC_POLYGON_COLLECTION_SET_ID, NEXT_PUBLIC_POLYGON_COMMUNITY, NEXT_PUBLIC_POLYGON_ZKEVM_COLLECTION_SET_ID, NEXT_PUBLIC_POLYGON_ZKEVM_COMMUNITY, NEXT_PUBLIC_RESERVOIR_API_KEY, NEXT_PUBLIC_SEPOLIA_COLLECTION_SET_ID, NEXT_PUBLIC_SEPOLIA_COMMUNITY, RESERVOIR_API_KEY } from 'smash.config'
...
//   apiKey: NEXT_PUBLIC_RESERVOIR_API_KEY,
//   coingeckoId: 'ethereum',
//   collectionSetId: NEXT_PUBLIC_POLYGON_ZKEVM_COLLECTION_SET_ID,
//   community: NEXT_PUBLIC_POLYGON_ZKEVM_COMMUNITY,
// }
...
//   apiKey: NEXT_PUBLIC_RESERVOIR_API_KEY,
//   coingeckoId: 'ethereum',
//   collectionSetId: NEXT_PUBLIC_ETH_COLLECTION_SET_ID,
//   community: NEXT_PUBLIC_ETH_COMMUNITY,
// }
...
export const DefaultChain: ReservoirChain = {
  ...
  apiKey: NEXT_PUBLIC_RESERVOIR_API_KEY,
  coingeckoId: 'ethereum',
  collectionSetId: NEXT_PUBLIC_SEPOLIA_COLLECTION_SET_ID,
  community: NEXT_PUBLIC_SEPOLIA_COMMUNITY,
}
...
export default [
  DefaultChain,
  {
    ...
    collectionSetId: NEXT_PUBLIC_POLYGON_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_POLYGON_COMMUNITY,
  ...
  },
  {
    ...
    collectionSetId: NEXT_PUBLIC_GOERLI_COMMUNITY,
    community: NEXT_PUBLIC_GOERLI_COMMUNITY,
  },
  {
    ...sepolia,
    lightIconUrl: '/icons/goerli-icon-dark.svg',
  ...
  },
  {
    ...
    collectionSetId: NEXT_PUBLIC_ARBITRUM_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_ARBITRUM_COMMUNITY,
  ...
  },
  {
    ...
    apiKey: RESERVOIR_API_KEY,
    coingeckoId: 'ethereum',
    collectionSetId: NEXT_PUBLIC_ARBITRUM_NOVA_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_ARBITRUM_NOVA_COMMUNITY,
  },
  {
    ...optimism,
    name: 'Optimism',
    ...
    collectionSetId: NEXT_PUBLIC_OPTIMISM_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_OPTIMISM_COMMUNITY,
  ...
  },
  {
    ...
    collectionSetId: NEXT_PUBLIC_BSC_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_BSC_COMMUNITY,
  ...
  },
  {
    ...
    collectionSetId: NEXT_PUBLIC_AVALANCHE_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_AVALANCHE_COMMUNITY,
  },
  {
    ...base,
    ...
    apiKey: RESERVOIR_API_KEY,
    coingeckoId: 'ethereum',
    collectionSetId: NEXT_PUBLIC_BASE_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_BASE_COMMUNITY,
  },
  {
    ...linea,
    ...
    apiKey: RESERVOIR_API_KEY,
    coingeckoId: 'ethereum',
    collectionSetId: NEXT_PUBLIC_LINEA_COLLECTION_SET_ID,
    community: NEXT_PUBLIC_LINEA_COMMUNITY,
  },
] as ReservoirChain[]

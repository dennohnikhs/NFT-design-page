...
import { ALLOWED_API_DOMAINS } from 'smash.config'
...
const allowedDomains = ALLOWED_API_DOMAINS
  ? ALLOWED_API_DOMAINS.split(',')
  : null
...
const proxy = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    console.log("SERVER API",{url:url.href, options});

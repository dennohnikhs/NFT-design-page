    ...
    return (
      <Html>
        ...
        <link
          rel="shortcut icon"
          type="image/svg"
          href="/SmashNFT-logo/Smashicon.png"
        />

        {/* Reservoir meta tags */}
        <meta property="reservoir:title" content="Smashnft NFT Explorer" />
        <meta property="reservoir:icon" content="/SmashNFT-logo/Smashicon.png" />
        <meta

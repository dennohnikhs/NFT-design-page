...
import { SmashNftModal } from 'components/modal/SmashNftModal'
import 'swiper/css'; 
import 'swiper/css/navigation';
import CollectionsCarousel from 'components/home/CollectionCarousel'
...
const topCollectionImage =
  ...
  return (
    <Layout>
      ...
      >
        {/* start of slider */}
      <CollectionsCarousel topCollections={sampleCollections} />
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {bannerImage?.length && bannerImage?.length > 0 ? (
                            <img
                              loading="lazy"
                              src={optimizeImage(
                                bannerImage ,
                          ...
                          <Img
                            src={
                              optimizeImage(collectionImage, 72 * 2) as string
                            }

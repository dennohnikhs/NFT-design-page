...
const IndexPage: NextPage = () => {
  ...
  const {connectedWallet,isConnected} = useSmashNft()
  ...
  const isOwner =
    !router.query.address || router.query.address[0] === connectedWallet

  const {
    avatar: ensAvatar,
    name: resolvedEnsName,
    shortAddress,
  } = useENSResolver(connectedWallet??undefined);
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <TabsTrigger value="items">Items 6</TabsTrigger>
                      ...
                      >
                        ...
                        >
                          ...
                          <TokenTable
                            ref={tokenTableRef}
                            isLoading={collectionsLoading}
                            address={(connectedWallet as `0x${string}`)??undefined}
                            filterCollection={filterCollection}
                            sortBy={sortByType}
                            selectedItems={selectedItems}
                            setSelectedItems={setSelectedItems}
                    ...
                    <TabsContent value="listings">
                      <ListingsTable address={(connectedWallet as `0x${string}`)??undefined} isOwner={isOwner} />
                    </TabsContent>
                    <TabsContent value="offers">
                      <OffersTable address={(connectedWallet as `0x${string}`)??undefined} isOwner={isOwner} />
                    </TabsContent>
                    <TabsContent value="activity">
                      ...
                      >
                        ...
                        >
                          ...
                          <UserActivityTable
                            user={(connectedWallet as `0x${string}`)??undefined}
                            activityTypes={activityTypes}
                          />
                        </Box>
                      </Flex>
